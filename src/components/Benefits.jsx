    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="bg-yellow-100 text-yellow-700 px-4 py-2 rounded-full text-sm font-bold uppercase tracking-wider">
            Why Choose RSR
          </span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-green-50 to-transparent rounded-2xl transform group-hover:scale-105 transition-transform duration-300" />
        ...
        <div className="mt-20 bg-gradient-to-br from-gray-900 via-green-700 to-gray-900 rounded-3xl p-8 md:p-12 text-center shadow-2xl">
