        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="text-center space-y-6 sm:space-y-8 animate-fade-in">
            <div className="inline-block mt-10">
              <span className="bg-blue-500 text-black px-4  sm:px-6 py-2 rounded-full text-sm font-bold uppercase tracking-wider shadow-md">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 pt-4 sm:pt-6">
              <button
                ...
                className="group bg-gradient-to-r from-blue-500 to-blue-600 text-white px-8 sm:px-10 py-3 sm:py-4 rounded-full text-base sm:text-lg font-bold hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-2 sm:gap-3 shadow-md"
              >
                Book Your Demo
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 sm:pt-6 text-gray-200 text-sm sm:text-base">
              ...
              <a href="mailto:info@travelpartner.com" className="flex items-center gap-2 hover:text-blue-400 transition-colors">
            ...
            {/* <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 pt-8 sm:pt-12 max-w-5xl mx-auto">
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 sm:p-6 hover:bg-white/20 hover:scale-105 transition-all duration-300 text-center">
                <div className="text-3xl sm:text-4xl font-bold text-blue-400 mb-1 sm:mb-2">300+</div>
                <div className="text-white font-semibold text-sm sm:text-base">Premium Vehicles</div>
              </div>
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 sm:p-6 hover:bg-white/20 hover:scale-105 transition-all duration-300 text-center">
                <div className="text-3xl sm:text-4xl font-bold text-blue-400 mb-1 sm:mb-2">24/7/365</div>
                <div className="text-white font-semibold text-sm sm:text-base">Dedicated Support</div>
              </div>
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 sm:p-6 hover:bg-white/20 hover:scale-105 transition-all duration-300 text-center">
                <div className="text-3xl sm:text-4xl font-bold text-blue-400 mb-1 sm:mb-2">100%</div>
                <div className="text-white font-semibold text-sm sm:text-base">Certified Drivers</div>
              </div>
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 sm:p-6 hover:bg-white/20 hover:scale-105 transition-all duration-300 text-center">
                <div className="text-3xl sm:text-4xl font-bold text-blue-400 mb-1 sm:mb-2">50K+</div>
